...
const MyWorks = () => {
  ...
  return (
    <div className=" md:my-24 w-full">
      ...
      <div className="mx-auto xs:hidden sm:hidden md:hidden lg:block lg:w-full lg:px-20 my-12">
        <Grid>
          <Grid.Row columns={4}>
            <Grid.Column>
              <Animated
      ...
      <div className="mx-auto xs:bloc lg:hidden   my-12">
        <Grid stretched verticalAlign="middle" container centered>
          <Grid.Row>
            <Grid.Column>
              <Animated
                animationIn="bounceInDown"
